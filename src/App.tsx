...
function App() {
  ...
  return (
    <div className="w-screen h-screen bg-primaryGray flex justify-center items-center">
      {!gameEnded 
        ? 
        <div className="bg-primaryPurple flex flex-col py-12 px-8 max-w-[420px] w-full rounded-lg text-center relative mx-2">
